...
_CODEX_FREEZONE_DEVELOPER_INSTRUCTIONS = (
    ...
    "ratio, resolution/quality, and output count. Video choices are model or generation mode, aspect "
    "ratio, resolution, duration, sound generation, and output count. Offer a recommended/default "
    ...
    "image_aspect_ratio, image_resolution, image_quality, image_count, video_model, "
    "video_aspect_ratio, video_resolution, video_duration_seconds, video_generate_audio, and "
    "video_count keys. If a canvas write returns code=generation_parameters_required, never retry "

...
- Before asking questions or drafting, classify the Skill Studio source mode:
  ...
  - distill_from_canvas: the user explicitly asks to save/distill/summarize/turn the current canvas, current flow, selected nodes, this project, this workflow, or existing workflow into a Skill or Recipe. In this mode, read the relevant canvas context, infer the reusable workflow, then ask 1-2 high-level confirmation questions first instead of immediately presenting a draft.
